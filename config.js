...
const TRANSLATIONS = {
  ja: {
    ...
    mobileInstruction: "📱 ろうそくを1本ずつ吹き消して、願いを込めてくださいね！",
    surpriseMessages: [
  ...
  vi: {
    ...
    blowInstruction: "Thổi tắt từng cây nến để ước các điều ước",
    ...
    mobileInstruction: "📱 Thổi tắt từng cây nến để ước các điều ước",
    surpriseMessages: [
